...
public final class ActivityFragmentMainBinding implements ViewBinding {
  ...
  private ActivityFragmentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull FragmentContainerView container) {
  ...
  public static ActivityFragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFragmentMainBinding((ConstraintLayout) rootView, bottomNavigation,
          container);
    }
