...
public final class FragmentRatingBinding implements ViewBinding {
  ...
  private FragmentRatingBinding(@NonNull ConstraintLayout rootView, @NonNull TextView rating) {
  ...
  public static FragmentRatingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRatingBinding((ConstraintLayout) rootView, rating);
    }
